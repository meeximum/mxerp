...
<f:view>
<h:form>
<f:subview id="ui_detail-views_customer-persong_sv">
...
<t:label id="g_33" text="Vorname" />
<t:field id="g_34" enabled="#{d.PartnerPB.inEditMode}" text="#{d.PartnerPB.data.nameFirst}" width="250" />
<t:coldistance id="g_35" />
<t:label id="g_23" text="Nachname" />
<t:field id="g_24" enabled="#{d.PartnerPB.inEditMode}" text="#{d.PartnerPB.data.nameLast}" width="250" />
</t:colsynchedrow>
</t:colsynchedpane>
</t:row>
</t:foldablepane>
